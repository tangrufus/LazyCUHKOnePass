...
* Add switch icon
* Support staff usernames
* Support OnePass login
* Support ITSC service desk login
* Support Sports Facilities Booking System login
* Support Workshop Registration System
* Redirect to https://google.com after wifi login
* Fix bugs
